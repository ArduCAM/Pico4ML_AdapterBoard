...
void setup() {
...
#if SCREEN
  ST7735_Init();
  ST7735_DrawImage(0, 0, 160, 80, arducam_logo);
#endif
  // Start serial
  setup_uart();
  stdio_usb_init();
  ...
  ST7735_DrawImage(80, 0, 80, 40, IMU_ICM20948);
  ST7735_WriteString(90, 40, "Magic", Font_11x18, ST7735_BLACK, ST7735_GREEN);
  ST7735_WriteString(90, 60, "Wand", Font_11x18, ST7735_BLACK, ST7735_GREEN);
#endif
  gpio_put(25, !gpio_get(25));
}
void loop() {
  ...
  // printf("done_just_triggered=%d linked=%d\r\n",done_just_triggered,!linked);
  ...
  if (done_just_triggered and !linked) {
    ...
    ST7735_FillRectangle(0, 20, ST7735_HEIGHT, ST7735_HEIGHT, ST7735_GREEN);
    ST7735_FillRectangle(23, 20, 34, 34, ST7735_BLACK);
    ST7735_DrawImage(24, 21, 32, 32, displayBuf);
    ST7735_WriteString(15, 60, str, Font_11x18, ST7735_BLACK, ST7735_GREEN);
#endif
    delete[] displayBuf;
  }
}

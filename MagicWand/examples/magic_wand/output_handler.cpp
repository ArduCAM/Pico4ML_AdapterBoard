...
void HandleOutput(tflite::ErrorReporter *error_reporter, int kind) {
  ...
  if (kind == 0) {
    ...
    TF_LITE_REPORT_ERROR(error_reporter, "WING:\n\r"
                                         "*         *         *\n\r"
                                         " *       * *       *\n\r"
                                         "  *     *   *     *\n\r"
                                         "   *   *     *   *\n\r"
    ...
    ST7735_FillRectangle(0, y, ST7735_HEIGHT, ST7735_HEIGHT, ST7735_GREEN);
    ...
    TF_LITE_REPORT_ERROR(error_reporter, "RING:\n\r"
                                         "          *\n\r"
                                         "       *     *\n\r"
                                         "     *         *\n\r"
                                         "    *           *\n\r"
    ...
    TF_LITE_REPORT_ERROR(error_reporter, "SLOPE:\n\r"
                                         "        *\n\r"
                                         "       *\n\r"
                                         "      *\n\r"
                                         "     *\n\r"
